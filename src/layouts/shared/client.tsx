...
import type {BaseLayoutProps, LinkItemType} from './index';
import {
...
import type {LanguageSelectProps, LanguageSelectTextProps} from './slots/language-select';
import {
...
import type {SearchTriggerProps, FullSearchTriggerProps} from './slots/search-trigger';
...
export interface BaseSlotsProps<
  TProps extends BaseLayoutProps = BaseLayoutProps,
> extends Pick<TProps, 'nav'> {
  themeSwitch: Omit<NonNullable<TProps['themeSwitch']>, 'enabled'>
  searchToggle: Omit<NonNullable<TProps['searchToggle']>, 'enabled'>
}
